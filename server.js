...
app.listen(config.port, async () => {
    ...
    await sequelize.models.Reply.create({ content: "asdff", board_idx: "1", userid: "admin" });
    await sequelize.models.Reply.create({ content: "asdfqwrf", board_idx: "1", userid: "admin" });
    await sequelize.models.Reply.create({ content: "asdwqrqff", board_idx: "1", userid: "admin" });
